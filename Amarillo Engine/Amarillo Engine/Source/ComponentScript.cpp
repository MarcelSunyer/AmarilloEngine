...
//			if (TextCmp(data_name.data(), script->data_structures[i].first.data())) {
...
//					if (TextCmp(inspector_variables[i].variable_name.data(), val_name.data()) && inspector_variables[i].variable_type == val_type) {
//						switch (inspector_variables[i].variable_type) {
//						case InspectorScriptData::DataType::INT: {
//							int* value = (int*)inspector_variables[i].ptr;
